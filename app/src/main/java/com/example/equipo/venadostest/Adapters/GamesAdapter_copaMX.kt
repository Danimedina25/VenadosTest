...
class GamesAdapter_copaMX (val games: List<Games>) : RecyclerView.Adapter<GamesAdapter_copaMX.ViewHolder>() {
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(datagames: Games) {
            if(datagames.league.equals("Copa MX")){
            ...
            }else if (datagames.league.equals("Ascenso MX")){
